package com.spring.Drive_BE.controller;

import com.spring.Drive_BE.entity.FileEntity;
import com.spring.Drive_BE.services.FileServiceStorage;
...
public class FileController {
    ...
    @PostMapping("/upload")                                     //file is key
                                              ...
                                              @RequestParam(value = "parentFolderId",required = false) Long parentFolderId )
    {
        try {
            ...
            return ResponseEntity.status(500).body("Files upload failed");
        }
    }
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable Long id)
    {
        try {
            ...
            return ResponseEntity.ok()
                    .header("content-Disposition","attachment;filname=\""+fileEntity.getName()+"\"")
                    .body(resource);
